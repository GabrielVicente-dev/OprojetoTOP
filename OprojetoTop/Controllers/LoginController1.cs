...
namespace ProjetoEcommerce.Repositorio
{
    ...
    public class LoginController1(IConfiguration configuration)
    {
        ...
        public void Cadastrar(Usuario usuario)
        {
            ...
            using (var conexao = new MySqlConnection(_conexaoMySQL))
            {
                ...
                MySqlCommand cmd = new MySqlCommand("insert into usuario (Nome,Email values (@nome, @email)", conexao); // @: PARAMETRO
        ...
        public Usuario ObterUsuario(int Codigo)
        {
            ...
            using (var conexao = new MySqlConnection(_conexaoMySQL))
            {
                ...
                while (dr.Read())
                {
                    ...
                    //cliente.TelCi = (string)(dr["TelCli"]); //propriedade telefone e passando string
